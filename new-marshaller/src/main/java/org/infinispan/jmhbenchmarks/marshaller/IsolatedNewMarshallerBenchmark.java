...
public class IsolatedNewMarshallerBenchmark {
   ...
   @Benchmark
   public void newMarshallerGetIsolated(NewInfinispanHolder ih, Blackhole bh, KeyGenerator kg) throws Exception {
   ...
   @Benchmark
   public void newMarshallerPutIsolated(NewInfinispanHolder ih, Blackhole bh, KeyGenerator kg) throws Exception {
      Object key = kg.getNextKey();
